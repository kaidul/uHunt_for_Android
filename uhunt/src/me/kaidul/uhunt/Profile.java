...
public class Profile extends SherlockFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		solvedProblems = (TextView) getSherlockActivity().findViewById(
				R.id.solved_problem_list);
		failedToSolve = (TextView) getSherlockActivity().findViewById(
				R.id.tried_but_failure_list);
		solvedAndSubmissions = (TextView) getSherlockActivity().findViewById(
				R.id.solved_and_submissions);
		nameAndusername = (TextView) getSherlockActivity().findViewById(
				R.id.name_and_username);
		failedTitle = (TextView) getSherlockActivity().findViewById(
