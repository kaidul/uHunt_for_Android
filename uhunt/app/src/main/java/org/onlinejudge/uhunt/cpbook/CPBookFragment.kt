...
class CPBookFragment : Fragment() {
    ...
    private lateinit var problemsCategoryStateAdapter: ProblemsCategoryStateAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getCPBookProblems().observe(viewLifecycleOwner, Observer { problemCategoryList ->
            problemsCategoryStateAdapter = ProblemsCategoryStateAdapter(this, problemCategoryList)
            tabsViewPager.adapter = ProblemsCategoryStateAdapter(this, problemCategoryList)
