...
public class Verdict {
	String name;
	String verdictShortCode;
	String verdictColorHex;
	
	public Verdict() {
		// empty constructor for giving compiler a blowjob
	}
	
	public Verdict(String name, String verdictShortCode, String verdictColorHex) {
		this.name = name;
		this.verdictShortCode = verdictShortCode;
		this.verdictColorHex = verdictColorHex;
	}
